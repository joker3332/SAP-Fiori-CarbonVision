...
class ChatAI {
    ...
    role:'system',content:'Keep the answer short and precise around 80 words unless you are asked to give detailed answer. Dont answer question not related to carbon tracking & reduction'}, ...this.selectedConversation.messages].map(message => { 
