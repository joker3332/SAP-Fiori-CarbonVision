...
class ChatAI {
    ...
    constructor(options) {
        let defaults = {
            ...
            container: '.chat-ai',
            chat_speed: 30,
            title: 'SAP - CarbonVision - CarbonVision',
            max_tokens: 100,
            version: '1.0.0',
            show_tokens: false,
    ...
    getMessage() {
        ...
        let messages = [{ role: 'system', content: 'You are an EYYSAPPET Energy Business Expert. Provide valuable recommendations on carbon emission tracking and reduction for the company or user.',
    role:'system',content:'Keep the answer short and precise around 100 words unless you are asked to give detailed answer. Dont answer question not related to carbon tracking & reduction'}, ...this.selectedConversation.messages].map(message => { 
